...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_MTGAP] = LAYOUT_wrapper(
    ...
    KC_LSFT,   __________________MTGAP_L3_________________, FN,         FN,       __________________MTGAP_R3_________________, KC_BSLS,
                               KC_LALT, LGUI_LNG2, NAV_ESC, LSFT_SPC,   RCTL_ENT, SYM_TAB, RGUI_LNG1, FN_GRV
  ),
  ...
  [_FN] = LAYOUT_wrapper(
    ...
    XXXXXXX, __________________FN_L3____________________, _______, LSG(KC_4), __________________FN_R3____________________, KC_MUTE,
