...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_SHINGETA] = LAYOUT_wrapper(
    RHYPR_TAB, __________________SHINGETA_L1______________, C(KC_1),    C(KC_4), __________________SHINGETA_R1______________, KC_BSPC,
    LCTL_ESC,  __________________SHINGETA_L2______________, C(KC_2),    C(KC_5), __________________SHINGETA_R2______________, RCTL_SG_QUOT,
    LSFT_CW,   __________________SHINGETA_L3______________, C(KC_3),    C(KC_6), __________________SHINGETA_R3______________, RSFT_BSLS,
                               KC_LALT, LGUI_LNG2, NAV_ESC, LSFT_SPC,   RCTL_ENT, SYM_TAB, RGUI_LNG1, FN_GRV
  ),

  [_JSYM] = LAYOUT_wrapper(
    _______, XXXXXXX, XXXXXXX, XXXXXXX, _______, XXXXXXX, XXXXXXX,    XXXXXXX, __________________JSYM_R1__________________, XXXXXXX,
    _______, __________________NONE_____________________, XXXXXXX,    XXXXXXX, __________________JSYM_R2__________________, JSYM_QUOT,
    _______, __________________NONE_____________________, XXXXXXX,    XXXXXXX, __________________JSYM_R3__________________, XXXXXXX,
