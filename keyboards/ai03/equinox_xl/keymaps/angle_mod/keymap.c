...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_BASE] = LAYOUT_wrapper(
    RHYPR_TAB, __________________BASE_L1__________________,      KC_LBRC, __________________BASE_R1__________________, KC_BSLS, KC_QUOT,
    LCTL_ESC,  __________________BASE_L2__________________,      KC_RBRC, __________________BASE_R2__________________,          KC_BSPC,
    KC_LSFT,   __________________BASE_L3__________________, NAV, KC_BSLS, __________________BASE_R3__________________,          FN_BSLS,
    KC_LALT,   XXXXXXX, LGUI_LNG2,                LSFT_SPC,      KC_RCTL, SYM_ENT,                          RGUI_LNG1, XXXXXXX, FN_GRV
  ),

  [_MTGAP] = LAYOUT_wrapper(
    RHYPR_TAB, __________________MTGAP_L1_________________,      KC_LBRC, __________________MTGAP_R1_________________, KC_Z,    KC_Q,
    LCTL_ESC,  __________________MTGAP_L2_________________,      KC_RBRC, __________________MTGAP_R2_________________,          KC_BSPC,
    KC_LSFT,   __________________MTGAP_L3_________________, NAV, KC_BSLS, __________________MTGAP_R3_________________,          FN_BSLS,
    KC_LALT,   XXXXXXX, LGUI_LNG2,                LSFT_SPC,      KC_RCTL, SYM_ENT,                          RGUI_LNG1, XXXXXXX, FN_GRV
  ),
  ...
  [_NAV] = LAYOUT_wrapper(
    ...
    _______, __________________NAV_L3___________________, _______, XXXXXXX, __________________NAV_R3___________________,           _______,
  ...
  [_SYM] = LAYOUT_wrapper(
    ...
    _______, __________________SYM_L3___________________, _______, XXXXXXX, __________________SYM_R3___________________,          _______,
    _______, XXXXXXX, _______,                   _______,          _______, _______,                            _______, XXXXXXX, _______
  ),
  ...
  [_FN] = LAYOUT_wrapper(
    ...
    XXXXXXX, __________________FN_L3____________________, XXXXXXX, XXXXXXX, LSG(KC_4), XXXXXXX, KC_VOLD, KC_VOLU, KC_MUTE,          _______,
