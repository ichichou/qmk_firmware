...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_BASE] = LAYOUT_wrapper(
    ...
    KC_LSFT,   __________________BASE_L3__________________, NAV, KC_GRV,  __________________BASE_R3__________________,                   KC_UP,   FN_BSLS,
    FN,        KC_LALT, LGUI_LNG2,                LSFT_SPC,      KC_RCTL, SYM_ENT,                 RGUI_LNG1, KC_RALT,          KC_LEFT, KC_DOWN, KC_RGHT
  ),

  [_MTGAP] = LAYOUT_wrapper(
    KC_ESC,    __________________1_TO_5___________________,      KC_6,    __________________7_TO_MINS________________, KC_EQL,  KC_BSPC, KC_DEL,  KC_DEL,
    RHYPR_TAB, __________________MTGAP_L1_________________,      KC_LBRC, __________________MTGAP_R1_________________, MT_QUOT, KC_BSLS,          KC_PGUP,
    LCTL_ESC,  __________________MTGAP_L2_________________,      KC_RBRC, __________________MTGAP_R2_________________, KC_ENT,                    KC_PGDN,
    KC_LSFT,   __________________MTGAP_L3_________________, NAV, KC_GRV,  __________________MTGAP_R3_________________,                   KC_UP,   FN_BSLS,
    FN,        KC_LALT, LGUI_LNG2,                LSFT_SPC,      KC_RCTL, SYM_ENT,                 RGUI_LNG1, KC_RALT,          KC_LEFT, KC_DOWN, KC_RGHT
  ),
  ...
  [_NAV] = LAYOUT_wrapper(
    ...
    _______, __________________NAV_L3___________________, _______, XXXXXXX, __________________NAV_R3___________________,                   XXXXXXX, _______,
  ...
  [_SYM] = LAYOUT_wrapper(
    ...
    _______, __________________SYM_L3___________________, _______, XXXXXXX, __________________SYM_R3___________________,                      XXXXXXX, _______,
    _______, _______, _______,                   _______,          _______, _______,                   _______, _______,             XXXXXXX, XXXXXXX, XXXXXXX
  ),
  ...
  [_WIN] = LAYOUT_wrapper(
    ...
    XXXXXXX, __________________WIN_L3___________________, _______, XXXXXXX, __________________WIN_R3___________________,                        XXXXXXX, XXXXXXX,
  ...
  [_FN] = LAYOUT_wrapper(
    ...
    XXXXXXX, __________________FN_L1____________________,          BASE,    __________________FN_R1____________________, XXXXXXX, XXXXXXX,          G(KC_UP),
    XXXXXXX, __________________FN_L2____________________,          MTGAP,   __________________FN_R2____________________, KC_MPLY,                   G(KC_DOWN),
    XXXXXXX, __________________FN_L3____________________, XXXXXXX, XXXXXXX, __________________FN_R3_LEFT_SHIFTED_______,                   KC_PGUP, _______,
    _______, XXXXXXX, XXXXXXX,                    EE_CLR,          XXXXXXX, QK_BOOT,                   XXXXXXX, XXXXXXX,          KC_HOME, KC_PGDN, KC_END
  ),
