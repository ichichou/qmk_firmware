...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_FN] = LAYOUT_all(
    ...
    _______,            LCA(KC_U),    LCA(KC_I), XXXXXXX,   MEH(KC_C),    XXXXXXX, XXXXXXX, XXXXXXX, LCA(KC_BSPC), XXXXXXX, XXXXXXX, XXXXXXX, KC_TILD,  KC_GRV,           G(KC_UP),
    _______,            LCA(KC_LEFT), XXXXXXX,   XXXXXXX,   LCA(KC_RGHT), XXXXXXX, XXXXXXX, XXXXXXX, LCA(KC_C),    XXXXXXX, KC_MPRV, KC_MNXT,           KC_MPLY,          G(KC_DOWN),
    _______,   XXXXXXX, LCA(KC_Z),    LCA(KC_X), LCA(KC_V), LCA(KC_B),    XXXXXXX, QK_BOOT, XXXXXXX, LCA(KC_ENT),  KC_VOLD, KC_VOLU, KC_MUTE,           XXXXXXX,          _______,
