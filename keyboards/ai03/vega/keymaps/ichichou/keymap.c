...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_MTGAP] = LAYOUT_all(
    KC_ESC,            KC_1,      KC_2,    KC_3,    KC_4,   KC_5,     KC_6,    KC_7,   KC_8, KC_9,    KC_0,      KC_MINS, KC_EQL,  HYPR_BSPC, KC_DEL, KC_DEL,
    HYPR_TAB,          KC_Y,      KC_P,    KC_O,    KC_U,   KC_SCLN,  KC_GRV,  KC_K,   KC_D, KC_L,    KC_C,      KC_W,    KC_Q,    KC_BSLS,           KC_GRV,
    CTL_ESC,           KC_I,      KC_N,    KC_E,    KC_A,   KC_COMM,  KC_RBRC, KC_M,   KC_H, KC_T,    KC_S,      KC_R,             CTL_ENT,           KC_TILD,
    SFT_CW,   KC_BSLS, KC_Z,      KC_SLSH, KC_QUOT, KC_DOT, KC_X,     KC_LBRC, KC_B,   KC_F, KC_G,    KC_V,      KC_J,             KC_UP,             MO(_FN),
    MO(_FN),  KC_LALT, GUI_LNG2,           KC_SPC,          SFT_SPC,           KC_SPC,       KC_RALT, RGUI_LNG1,          KC_LEFT, KC_DOWN,           KC_RGHT
  ),

  [_FN] = LAYOUT_all(
    LCG(KC_Q),          KC_F1,     KC_F2,      KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,   KC_DEL,  XXXXXXX, XXXXXXX,
    _______,            DF(_BASE), DF(_MTGAP), XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_TILD,  KC_GRV,           G(KC_UP),
    _______,            XXXXXXX,   XXXXXXX,    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_MPRV, KC_MNXT,           KC_MPLY,          G(KC_DOWN),
    _______,   XXXXXXX, XXXXXXX,   XXXXXXX,    XXXXXXX, XXXXXXX, XXXXXXX, QK_BOOT, XXXXXXX, XXXXXXX, KC_VOLD, KC_VOLU, KC_MUTE,           XXXXXXX,          _______,
