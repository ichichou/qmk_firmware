...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_BASE] = LAYOUT_wrapper(
    ...
    KC_LSFT,   __________________BASE_L3__________________,             __________________BASE_R3__________________, FN_BSLS,
  ...
  [_MTGAP] = LAYOUT_wrapper(
    ...
    KC_LSFT,   __________________MTGAP_L3_________________,             __________________MTGAP_R3_________________, FN_BSLS,
                          FN, LGUI_LNG2, NAV_ESC, LSFT_SPC,             RCTL_ENT, SYM_TAB, RGUI_LNG1, RALT_GRV
  ),
