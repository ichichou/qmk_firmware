...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_MTGAP] = LAYOUT_wrapper(
    ...
    KC_LSFT,    __________________MTGAP_L3_________________, __________________MTGAP_R3_________________,     MT_BSLS,
    FN,      KC_RCTL, KC_LALT, LGUI_LNG2, NAV_ESC, LSFT_SPC, RCTL_ENT, SYM_BSPC, RGUI_TAB, KC_RALT, KC_RCTL,  FN_GRV
  ),

  [_NAV] = LAYOUT_wrapper(
    G(KC_RBRC), __________________NAV_L1___________________, __________________NAV_R1___________________, G(KC_UP),
    G(KC_LBRC), __________________NAV_L2___________________, __________________NAV_R2___________________, G(KC_DOWN),
