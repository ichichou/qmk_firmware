...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_WIN] = LAYOUT_wrapper(
    ...
    [_FN] = LAYOUT_wrapper(
      ...
      DM_REC1,   __________________FN_L2____________________,    __________________FN_R2____________________, KC_MPLY,
      DM_PLY1,   __________________FN_L3____________________,    __________________FN_R3____________________, KC_MUTE,
      _______,   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,  EE_CLR,    QK_BOOT, XXXXXXX, XXXXXXX, KC_LEFT, KC_RGHT, _______
    ),
  #endif
