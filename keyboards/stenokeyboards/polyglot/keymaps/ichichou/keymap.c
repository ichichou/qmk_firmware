...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_GEMINI] = LAYOUT_wrapper(
    ...
    XXXXXXX, __________________GEMINI_L3________________, __________________GEMINI_R3________________, FN,
  ...
  [_PLOVER] = LAYOUT_wrapper(
    ...
    XXXXXXX, __________________PLOVER_L3________________, __________________PLOVER_R3________________, FN,
  ...
  [_SYM] = LAYOUT_wrapper(
    ...
    _______, __________________SYM_L2___________________, __________________SYM_R2___________________, KC_COMM,
