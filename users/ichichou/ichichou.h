...
#define __________________SYM_R1___________________ KC_COMM, KC_AMPR, KC_CIRC, KC_DLR,  KC_LPRN
#define __________________SYM_R2___________________ KC_TILD, KC_1,    KC_PERC, KC_HASH, KC_LBRC
