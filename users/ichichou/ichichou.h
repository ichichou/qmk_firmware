...
#define __________________WIN_R1___________________ C(KC_4), MEH(KC_C),   A(KC_UP),    LCA(KC_UP),   XXXXXXX  // LCA(KC_BSPC)
#define __________________WIN_R2___________________ C(KC_5), LCA(KC_C),   A(KC_DOWN),  LCA(KC_DOWN), XXXXXXX  // MEH(KC_ENT)
...
#define __________________FN_L3____________________ XXXXXXX,    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
...
#define __________________FN_R3____________________ LSG(KC_4), XXXXXXX, XXXXXXX, KC_VOLD, KC_VOLU  // KC_MUTE

#define __________________FN_R3_LEFT_SHIFTED_______ LSG(KC_4), XXXXXXX, KC_VOLD, KC_VOLU, KC_MUTE  // FN
...
#define __________________NONE____________          XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
