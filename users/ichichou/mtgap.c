...
static bool mtgap_registered[32];
static bool qwerty_registered[32];
...
bool process_record_mtgap(uint16_t keycode, keyrecord_t *record, uint8_t mod_state) {
  switch (keycode) {
    ...
    case MT_B:    return process_mtgap_key(KC_B,    KC_SCLN, &qwerty_registered[1],  &mtgap_registered[1],  record, mod_state);
    case MT_C:    return process_mtgap_key(KC_C,    KC_SLSH, &qwerty_registered[2],  &mtgap_registered[2],  record, mod_state);
    ...
    case MT_T:    return process_mtgap_key(KC_T,    KC_J,    &qwerty_registered[19], &mtgap_registered[19], record, mod_state);
    ...
    case MT_X:    return process_mtgap_key(KC_X,    KC_Z,    &qwerty_registered[23], &mtgap_registered[23], record, mod_state);
    case MT_Y:    return process_mtgap_key(KC_Y,    KC_K,    &qwerty_registered[24], &mtgap_registered[24], record, mod_state);
    case MT_Z:    return process_mtgap_key(KC_Z,    KC_Q,    &qwerty_registered[25], &mtgap_registered[25], record, mod_state);
    case MT_SCLN: return process_mtgap_key(KC_SCLN, KC_R,    &qwerty_registered[26], &mtgap_registered[26], record, mod_state);
    case MT_QUOT: return process_mtgap_key(KC_QUOT, KC_QUOT, &qwerty_registered[27], &mtgap_registered[27], record, mod_state);
    ...
    case MT_SLSH: return process_mtgap_key(KC_SLSH, KC_X,    &qwerty_registered[30], &mtgap_registered[30], record, mod_state);
    case MT_BSLS: return process_mtgap_key(KC_BSLS, KC_BSLS, &qwerty_registered[31], &mtgap_registered[31], record, mod_state);
